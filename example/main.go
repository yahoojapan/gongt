...
var datasets = []*dataset{
	&dataset{"Fashion-MNIST","assets/bench/fashion-mnist-784-euclidean.hdf5"},
	&dataset{"GloVe-25", "assets/bench/glove-25-angular.hdf5"},
	&dataset{"GloVe-50", "assets/bench/glove-50-angular.hdf5"},
	&dataset{"GloVe-100", "assets/bench/glove-100-angular.hdf5"},
	&dataset{"GloVe-200", "assets/bench/glove-200-angular.hdf5"},
	&dataset{"MNIST", "assets/bench/mnist-784-euclidean.hdf5"},
	&dataset{"NYTimes", "assets/bench/nytimes-256-angular.hdf5"},
	&dataset{"SIFT", "assets/bench/sift-128-euclidean.hdf5"},
}
